...
--filter-tcp=80,443 --ipset="%LISTS%cloudflare_plain_ipv4.txt" --dpi-desync=fake --dpi-desync-ttl=1 --dpi-desync-autottl=-2 --orig-ttl=1 --orig-mod-start=s1 --orig-mod-cutoff=d1 --dpi-desync-fake-tls="%BIN%tls_clienthello_4pda_to.bin" --new ^
